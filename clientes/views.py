    ...
    def form_valid(self, form):
        try:
            ...
            if 'UNIQUE constraint failed' in e.args[0]:
                messages.warning(self.request, 'No se pudo crear esta consulta')
        ...
        messages.info(self.request, 'Consulta creada con exito!')
...
class ConsultaDeleteView(LoginRequiredMixin, DeleteView):
    ...
    def get_success_url(self):
        messages.success(self.request, "Consulta borrada con exito!")
...
class ConsultaListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        ...
        try:
            ...
            messages.warning(self.request, 'No tiene consultas')
            return None
        try:
